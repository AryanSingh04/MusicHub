  ...
  return (
      <div className='w-full text-white bg-[rgba(30,29,29,0.5)]'>
        ...
        <div className='lg:h-[90vh] flex items-center justify-between flex-col lg:flex-row gap-4 md:gap-0'>
          <div className='w-full h-1/2 lg:w-2/5 lg:h-full flex flex-col items-center justify-center gap-4 pt-8'>
          <img src={artist?.image.replace("150x150","500x500")} alt="" className='w-4/5 sm:w-2/5  lg:w-3/5 ' />     
          ...
          <div className='w-full lg:w-3/5  h-screen lg:h-full relative overflow-hidden'>
           <div className='py-2  h-[27%] flex flex-col justify-center pl-2'>
