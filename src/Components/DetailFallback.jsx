...
const DetailFallback = () => {
  return (
    <div className='w-screen h-[120vh] sm:h-[90vh]md:px-8 pt-14 flex flex-col lg:flex-row  gap-8  '>
        <div className="w-full h-full sm:w-1/3 lg:h-4/5 flex flex-col items-center  gap-4 pt-8 md:pt-0 ">
  <div className='w-4/5 h-full sm:h-4/5 animate-pulse rounded-md bg-slate-800'></div>
